import { Component, warn, UITransform, director, Director, TransformBit, NodeEventType, type Node, Enum, _decorator, Vec2, Size, Vec3 } from "cc";
const { property, disallowMultiple, menu, ccclass, help, executeInEditMode, executionOrder, requireComponent } = _decorator;
 ...
 */
@ccclass("BetterLayout")
// @help("i18n:cc.BetterLayout")
@executionOrder(110)
@menu("UI/BetterLayout")
@requireComponent(UITransform)
@executeInEditMode
@disallowMultiple
export class BetterLayout extends Component {
    /**
     * @en
    ...
    @property({
        visible: function(this: BetterLayout): boolean {
     ...
     */
    @property({
        visible: function(this: BetterLayout) {
