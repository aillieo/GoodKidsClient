...
export class DynamicScrollView extends ScrollView {
  ...
  private readonly managedItems: ScrollItemWithRect[] = new Array<ScrollItemWithRect>();
  ...
  private readonly viewWorldConers: Vec3[] = new Array<Vec3>(4);
  private readonly rectCorners: Vec3[] = new Array<Vec3>(2);
